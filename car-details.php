              ...
              <div class="col-lg-8">
                <section class='tabs-content' style="width: 100%;">
                  ...
                  <article id='tabs-2'>
                    ...
                    <p>- Vernieuwen van de website <br> - zorgen dat het systeem goed werkt<br> - . <br> - . <br> - . <br> - . <br> - . <br> - . <br> - . <br> - . <br> - . <br> - . <br> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco                         laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat                     cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p> 
                   </article>
                  <article id='tabs-3'>
                    <h4> Extras</h4>
                    ...
                    <div class="row">   
                        ...
                        <div class="col-sm-6">
                            <p>- Tijdens feestdagen leuke activiteiten met het bedrijf</p>
                        </div>
                        <div class="col-sm-6">
                            <p>- Goede werkomgeving</p>
                        </div>
                        <div class="col-sm-6">
                            <p></p>
                        </div>
                ...
                <a href="mailform1.php"><?php echo Vacature; ?></a>
            </div>
                    </div>
                  </article>
                </section>
