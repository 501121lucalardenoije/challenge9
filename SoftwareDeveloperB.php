...
<div class="container">
<center>
    <H1>Software Developer B</H1>
    <div class="card">
    <div class="card-body">
</BR>
    <H5>Vereisten: Algemene kennis hebben van HTML, JS, PHP EN MYSQL. Er moet ervaring zijn in het Back-end programeren van websites</h5>
</BR>
...
<h5>Salaris: Jij verdient als programmeur het stand salaris, dit valt tussen 1937 en 4400 euro.</h5>
</br>
<h5>Werkagenda: Jij werkt als Back-end developer 4 dagen in de week met een vrije dag naar keuze.</h5>
</br>
<h5>Contractsoort: Je begint met een parttime contract, aan de hand van jouw prestaties kun je worden gepromoveerd naar fulltime Back-end developer.</h5>
</br>
